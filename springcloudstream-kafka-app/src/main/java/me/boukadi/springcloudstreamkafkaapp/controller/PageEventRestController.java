package me.boukadi.springcloudstreamkafkaapp.controller;
...
public class PageEventRestController {
    // ALTERNATIVE TO KafkaTemplate this one is more generic,
    // can work with other messaging systems too e.g: RabbitMQ..etc
    @Autowired
